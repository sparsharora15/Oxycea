...
import aboutImg from "@/public/Rectangle15.png";
      ...
      <div id="about" className="mt-[50px] relative bg-[#69A4DA]">
        <div className="h-fit pb-[100px]">
          <div className="pt-[100px] flex flex-col items-center">
            <div className="flex gap-[0.75rem] items-center">
              <div className="hidden md:block w-[10rem] h-0 border-[1px] border-white" />
              <h1 className="text-white text-3xl">Oxycea</h1>
              <div className="hidden md:block w-[10rem] h-0 border-[1px] border-white" />
            </div>
            <p className="mt-[1.25rem] w-[85%] vsm:w-[90%] lg:w-[677px] text-justify text-white text-xs font-normal">
          ...
          <div className="w-[470px] h-[416px] ml-[-40%] lg:mx-auto mb-[2rem] lg:mt-[6.31rem] lg:mb-[10.38rem] lg:grid place-items-center">
            <Image className="h-fit" src={aboutImg} alt="machine" />
          </div>

          <div className="about-list lg:absolute left-[50%] lg:translate-x-[-50%] top-[30%] w-full lg:w-fit flex flex-col items-center gap-[3rem] lg:gap-[6rem]">
            <div className="w-full lg:w-fit flex justify-around lg:justify-normal  items-center lg:gap-[11.25rem]">
              <div className="list-item">
                <Image src={img1} alt="list_item" />
                <p>Faster healing of injuries and wounds</p>
              </div>
              <div className="list-item">
                <Image src={img2} alt="list_item" />
                <p>Increase circulation</p>
              </div>
            </div>

            <div className="w-full lg:w-fit flex justify-around lg:justify-normal  items-center lg:gap-[20rem] xl:gap-[34.63rem]">
              <div className="list-item">
                <Image src={img3} alt="list_item" />
                <p>Stem cell increase</p>
              </div>
              <div className="list-item">
                <Image src={img4} alt="list_item" />
                <p>Boost energy and physical performance</p>
              </div>
            </div>

            <div className="w-full lg:w-fit flex justify-around lg:justify-normal  items-center lg:gap-[28rem] xl:gap-[35.25rem]">
              <div className="list-item">
                <Image src={img5} alt="list_item" />
                <p>Strengthen Immune System</p>
              </div>
              <div className="list-item">
                <Image src={img6} alt="list_item" />
            ...
            <div className="w-full lg:w-fit flex justify-around lg:justify-normal  items-center lg:gap-[10.75rem]">
              <div className="list-item">
                <Image src={img7} alt="list_item" />
                <p>Increase Mental Clarity and alertness</p>
              </div>
              <div className="list-item">
                <Image src={img8} alt="list_item" />
                <p>Anti-Aging</p>
              </div>
            </div>
          </div>
